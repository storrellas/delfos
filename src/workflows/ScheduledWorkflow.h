...
class ScheduledWorkflow: public Workflow {
private:
...
public:
  ...
  constexpr static const char* SCHEDULED_WORKFLOW = "scheduled";
  static const string get_workflow_name(){ return string(SCHEDULED_WORKFLOW); }
  ScheduledWorkflow(

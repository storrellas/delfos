...
class InboundWorkflow: public Workflow {
private:
...
public:
  constexpr static const char* INBOUND_WORKFLOW = "inbound";
  static const string get_workflow_name(){ return string(INBOUND_WORKFLOW); }
  InboundWorkflow(
